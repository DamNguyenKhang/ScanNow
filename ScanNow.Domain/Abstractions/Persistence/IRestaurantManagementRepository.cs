...
namespace ScanNow.Domain.Abstractions.Persistence
{
    public interface IRestaurantManagementRepository
    {
        ...
        Task<Restaurant?> GetRestaurantBySlugAsync(string slug, CancellationToken ct = default);
        ...
        Task<Branch?> GetBranchBySlugAsync(Guid restaurantId, string slug, CancellationToken ct = default);
